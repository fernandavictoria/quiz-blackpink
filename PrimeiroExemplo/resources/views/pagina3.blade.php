    ...
    <div class="card-body">
        ...
        <form action="{{ route('dadosPagina3') }}" method="POST">
            ...
            <div class="form-group py-4">
                <label for="pergunta"><h3><strong>Quem é a integrante que ocupa a posição de rapper principal?? </strong></h3></label> <br>
                <label for="pergunta"><h5>quem faz o melhor rap geralmente também escrevem suas próprias letras</h5></label>
