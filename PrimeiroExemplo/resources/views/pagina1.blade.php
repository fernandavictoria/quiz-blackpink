    ...
    <div class="card-body">
        ...
        <form action="{{ route('dadosPagina1') }}" method="POST">
            ...
            <div class="form-group py-4">
                <label for="pergunta"><h3><strong>Quem é a integrante que ocupa a posição de vocal principal? </strong></h3></label> <br>
                <label for="pergunta"><h5>geralmente ganha a maior quantidade de linhas nas músicas e executa a maioria dos high notes </h5></label>
