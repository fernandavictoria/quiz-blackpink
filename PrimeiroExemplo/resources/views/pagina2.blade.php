    ...
    <div class="card-body">
        ...
        <form action="{{ route('dadosPagina2') }}" method="POST">
            ...
            <div class="form-group py-4">
                <label for="pergunta"><h3><strong>Quem é a integrante que ocupa a posição de visual do gruupo? </strong></h3></label> <br>
                <label for="pergunta"><h5>considerado o mais bonito ou atraente de acordo com os padrões de beleza coreanos</h5></label>
